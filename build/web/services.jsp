            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">What is Service Page?</h1>
                        <p class="mb-4">A service page is a part of a company website. As the name 
                            already suggests, it allows presenting the services or products offered by 
                            a particular brand to potential customers. A service page may be a subpage 
                            of your company website or a standalone web page in a different domain</p>
