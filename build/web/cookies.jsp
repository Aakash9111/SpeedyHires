            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">What is a Cookies Policy?</h1>
                        <p class="mb-4">A Cookies Policy allows the company to have full disclosure with its
                             users and creates a transparency of the collection of private information.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>What cookies are used by the company</p>
                        <p><i class="fa fa-check text-primary me-3"></i>How those cookies are used to collect the private 
                            information of visitors</p>
                        <p><i class="fa fa-check text-primary me-3"></i>How the user can control the disclosure of information
                             and use of the cookies for collection</p>
