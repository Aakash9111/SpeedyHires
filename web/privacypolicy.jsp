            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">What is a Privacy Policy?</h1>
                        <p class="mb-4">A Privacy Policy is a legal document outlining how your organization
                             collects, uses, and discloses personal information. A properly written Privacy 
                             Policy tells customers what data you collect about them when they engage with 
                             your business (e.g., through your website) or purchase one of your products/services,
                            and why you're collecting that information. It also lets people know how long their
                             information will be stored, who can access these records and more.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>The California Online Privacy Protection Act (CalOPPA)</p>
                        <p><i class="fa fa-check text-primary me-3"></i>The UK's Data Protection Act</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Europe's General Data Protection Regulation (GDPR)</p>
