            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">What are Terms and Conditions Agreements?</h1>
                        <p class="mb-4">A Terms and Conditions agreement acts as a legal contract 
                            between you (the company) and the user. It's where you maintain your rights 
                            to exclude users from your app in the event that they abuse your website/app, 
                            set out the rules for using your service and note other important details and 
                            disclaimers. 
                            While some clauses are standard and commonly seen in pretty much every Terms 
                            and Conditions agreement, it's up to you to set the rules and guidelines that 
                            the user must agree to. These terms are interchangeable,
                            practically speaking.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>If users abuse your website or mobile app in any way,
                             you can terminate their account.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>If users can post content on your website or mobile app 
                            (create content and share it on your platform), you can remove any
                            content they created if it infringes copyright.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>And many more examples.</p>
