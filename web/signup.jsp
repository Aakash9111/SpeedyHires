<html>
    ...
    <body>   
        ...
        <form method="post" action="signup" class="form border border-grey border-2">
            ...
            <div class="py-2">
                <input class='w-100' type="text" name="username" placeholder="E-mail" required/>    
            </div>
            <div class="py-2">
            ...
            <div class="" >
                <p>already have an account <a href="login.jsp" class=""><u><b>log in here </b></u></a></p>
            </div>
